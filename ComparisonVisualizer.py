...
time_factor = 1
publish_to_fusion = True

class ComparisonVisualizer(Node):
    def __init__(self, args):
        super().__init__('ComparisonVisualizer')
        ...
        if(publish_to_fusion):
            ...
            self.publisher_GT = self.create_publisher(RemoteObjectState, 'GT', 100)
    ...
    def to_markers(self, line):
        timestamp, sensor_id, track_id, track_status, confidence, object_type, obs_x_off, obs_y_off, obs_v_x, obs_v_y, obs_theta, obs_theta_valid, obs_theta_cov, obs_x_cov, obs_y_cov, obs_v_x_cov, obs_v_y_cov,int_x_off, int_y_off, int_v_x, int_v_y, lat_err, lon_err, v_lat_err, v_lon_err, int_heading, heading_err = line
        marker = Marker()
        ...
        match int(sensor_id):
            ...
            case _:
                ...
                marker.color.g = 1.0
                marker.color.b = 1.0
        if not publish_to_fusion and int(sensor_id) == 1:
